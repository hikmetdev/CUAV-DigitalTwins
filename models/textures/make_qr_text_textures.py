...
Metinler kısa tutulur ki QR versiyonu (modül sayısı) küçük kalsın — modül
başına düşen piksel arttıkça havadan çözüm o kadar sağlam olur. Türkçe
karakterler UTF-8 byte modunda sorunsuz gömülür/çözülür.
...
# Kutu sırası world'deki route_qr_box_N ile birebir eşleşir. Türkçe karakterler
# UTF-8 byte modunda gömülür (İ/Ş/Ö/Ü 2 bayt); metinler kısa kaldığı sürece QR
# versiyonu küçük kalır ve havadan çözüm sağlamlığı düşmez.
QR_TEXTS = {
    1: "İNNOVA",
    2: "BİLİŞİM",
    3: "ÇÖZÜMLERİ",
